    ...
    exec(msg, content) {
        ...
        if (attachment) {
            if (attachment.size > 0x7A1200)
                throw new CustomError_1.default("!PARSING", msg.ctx.lang("TYPE_IMAGE_SIZE_EXCEDED"));
        ...
        if (!IMAGE_PATTERN.test(ext))
            throw new CustomError_1.default("!PARSING", msg.ctx.lang("TYPE_IMAGE_UNSUPPORTED_EXT"));
        return content;
    }
}
