...
class TypeMember {
    ...
    exec(msg, content) {
        ...
        if (!members.size)
            throw new CustomError_1.default("!PARSING", msg.ctx.lang("TYPE_MEMBER_NOT_FOUND"));
        ...
        if (!selected && members.size > 1)
            throw new CustomError_1.default("!PARSING", msg.ctx.lang("TYPE_MEMBER_HAS_SIMILIAR", list));
