...
let default_1 = class default_1 extends Command_1.default {
    async exec(msg, { image }) {
        ...
        const { raw: attachment } = await node_superfetch_1.default.get("https://emilia-api.xyz/api/rejected")
...
default_1 = __decorate([
    decorators_1.DeclareCommand("rejected", {
        aliases: ["rejected"],
        description: {
            content: (msg) => msg.guild.loc.get("COMMAND_IMAGE_MANIPULATION_REJECTED_DESCRIPTION"),
