...
default_1 = __decorate([
    decorators_1.DeclareCommand("batslap", {
        aliases: ["batslap"],
        description: {
            content: (msg) => msg.guild.loc.get("COMMAND_IMAGE_MANIPULATION_BATSLAP_DESCRIPTION"),
            usage: "batslap <user>",
        ...
        args: [
            {
                ...
                match: "rest",
                type: "user",
                prompt: (msg) => msg.guild.loc.get("COMMAND_IMAGE_MANIPULATION_BATSLAP_PROMPT")
            }
        ]
    })
], default_1);
