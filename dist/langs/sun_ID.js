...
const id_ID_1 = __importDefault(require("@yumeko/langs/id_ID"));
const common_tags_1 = require("common-tags");
var Animals;
(function (Animals) {
    Animals[Animals["manuk"] = 0] = "manuk";
    Animals[Animals["kelinci"] = 1] = "kelinci";
    Animals[Animals["ucing"] = 2] = "ucing";
    Animals[Animals["anjing"] = 3] = "anjing";
    Animals[Animals["entog"] = 4] = "entog";
    Animals[Animals["ajag"] = 5] = "ajag";
    Animals[Animals["kangguru"] = 6] = "kangguru";
    Animals[Animals["koala"] = 7] = "koala";
    Animals[Animals["kadal"] = 8] = "kadal";
    Animals[Animals["bueg"] = 9] = "bueg";
