...
@DeclareCommand("gru-plan", {
    aliases: ["gru-plan"],
    description: {
        content: (msg): string => msg.ctx.lang("COMMAND_IMAGE_MANIPULATION_GRUPLAN_DESCRIPTION"),
    ...
    args: [
        {
            ...
            match: "single",
            type: "string",
            prompt: (msg): string => msg.ctx.lang("COMMAND_IMAGE_MANIPULATION_GRUPLAN_PROMPT_1")
        },
        {
            identifier: "secondStep",
            match: "single",
            type: "string",
            prompt: (msg): string => msg.ctx.lang("COMMAND_IMAGE_MANIPULATION_GRUPLAN_PROMPT_2")
        },
        {
            identifier: "thirdStep",
            match: "single",
            type: "string",
            prompt: (msg): string => msg.ctx.lang("COMMAND_IMAGE_MANIPULATION_GRUPLAN_PROMPT_3")
        }
    ]
})
